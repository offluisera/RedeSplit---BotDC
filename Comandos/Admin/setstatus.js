...
const DONO = "567410798025244672"; // Coloque seu ID
...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (interaction.user.id !== DONO) return interaction.reply({ content: `:x: Apenas o .luisera consegue utilizar este comando!`, ephemeral: true })
